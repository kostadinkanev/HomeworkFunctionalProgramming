...
class ByEmail
{
    static void Main()
    {
        var students = new List<Students>
        {
            ...
            new Students("Kiril", "Evstatiev", 22, 801275, "0896123448", "kk@ail.om",
        ...
        var stud =
            ...
            where (stu.Email.LastIndexOf("@") == stu.Email.Length - 7) && (stu.Email.Substring(stu.Email.Length - 7) == "@abv.bg")
            select stu;
